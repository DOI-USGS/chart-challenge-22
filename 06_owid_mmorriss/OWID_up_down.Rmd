...
g <- links %>%
  ...
  labs(title = "Basic Safe Drinking Water",
       subtitle = "<span style = 'color: white;'>Access to safe drinking water in</span> <span style = 'color: darkgoldenrod1;'>Urban</span> <span style = 'color: white;'>and</span> <span style = 'color: darkorchid;'>Rural</span> <span style = 'color: white;'>areas</span>"
       ) +
  theme_arc()

g

ggsave(here("Figures","Urban.pdf"), width = 16.5, height = 9, units = "in", dpi = 320)
```
...
ggsave(here("Figures","Rural.pdf"), width = 16.5, height = 10, units = "in", dpi = 320)
```
