...
dir.create('2_process/out/nlcd_reclassified/', showWarnings = FALSE)
dir.create('2_process/out/FOR_reclassified/', showWarnings = FALSE)
dir.create("3_visualize/out/", showWarnings = FALSE)

nlcd_years <- list('2001','2004','2006','2011','2013','2016',2019)

legend_df_path <- '1_fetch/in/legend_color_map_FORESCE.csv'
# defining reclassify_df for 
reclassify_df_FOR <- read.delim(legend_df_path, sep = ',') %>% filter(Reclassify_match != 'NA')
